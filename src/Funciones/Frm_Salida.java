...
import static Funciones.Frm_Principal.contenedor;
...
public class Frm_Salida extends javax.swing.JInternalFrame {
    private final SalidaProductos CP;
    TableColumnModel columnModel;
    public static int enviar = 0;
    int num = 0;
    
 // Metodo dedicado a iniciar el programa
    public Frm_Salida() {
        initComponents();
        CP = new SalidaProductos();
        columnModel = jtb_salida.getColumnModel();
        listar();
        iniciar();
    }
// Metodo dedicado a listar los datos en la tabla creada
    private void listar(){
        jtb_salida.setModel(CP.getDatosSalida());
        columnModel.getColumn(3).setPreferredWidth(350);
    }
// Metodo que inicia el proceso sin permitir que se editen o ingresen datos hasta que se aprete el boton de nuevo
...
// Metodo dedicado a habilitar el ingreso de los datos
...
// Metodo dedicado a limpiar todos los datos ingresados
...
// Metodo dedicado al boton guardar para guardar los datos ingresados 
    ...
    private void initComponents() {
        ...
        jbt_buscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Icono Buscar.jpg"))); // NOI18N
        ...
        bt_nuevo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Icono agregar.png"))); // NOI18N
        ...
        jbt_guardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Icono Guardar.png"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jbt_guardar, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(bt_nuevo))
                .addGap(34, 34, 34))
        );
